...
public interface GraphAlgorithmsInterface<T> {
	 ...
	 * @param origin An object that labels the origin vertex of this traversal.
	 * @return A queue of labels of the vertices in the traversal, with the label of the origin vertex at the queue's front.
	 */
	 ...
	 * @return A deque representing a stack of vertex labels in topological order, beginning with the stack's top.
	 */
